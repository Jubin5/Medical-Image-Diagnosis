...
model = r"C:\Users\jubin\Downloads\ensemble_cxr_new_model.keras"
...
file_path = "/content/ensemble_cxr_model.pkl"
print("File exists:", os.path.exists(file_path))
print("File size (bytes):", os.path.getsize(file_path) if os.path.exists(file_path) else "N/A")
